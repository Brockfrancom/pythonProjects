...
#############################################################
# module: cs3430_s20_hw07_uts.py
# description: unit tests for CS 3430: S20: Assignment 07
# rename parser module if necessary for your Python IDE
##############################################################
...
class Assign07UnitTests(unittest.TestCase):
    ...
    def test_hw07_prob01_ut01(self):
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 01: pass')

    def test_hw07_prob01_ut02(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 02 ************')
        f = lambda x: math.cos(x)
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 02: pass')

    def test_hw07_prob01_ut03(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 03 ************')
        f = lambda x: math.cos(x)
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 03: pass')

    def test_hw07_prob01_ut04(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 04 ************')
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 04: pass')
        
    def test_hw07_prob01_ut05(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 05 ************')
        f = lambda x: math.sin(x)
        av = cdd.drv1_ord4(f, 0.8, 0.01)
        tv = math.cos(0.8)
        err = 0.000001
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 05: pass')
    ...
    def test_hw07_prob01_ut07(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 07 ************')
        f = lambda x: math.e**x
        av = cdd.drv1_ord4(f, 0.8, 0.000001)
        tv = f(0.8)
        err = 0.00000001
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 07: pass')

    def test_hw07_prob01_ut08(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 08 ************')
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 08: pass')
    ...
    def test_hw07_prob01_ut11(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 11 ************')
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 11: pass')
    ...
    def test_hw07_prob01_ut13(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 13 ************')
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 13: pass')
    ...
    def test_hw07_prob01_ut16(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 16 ************')
        f = lambda x: math.cos(x)
        ## df is the ground truth derivative function
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 16: pass')
    ...
    def test_hw07_prob01_ut17(self):
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 17: pass')

    def test_hw07_prob01_ut18(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 18 ************')
        f = lambda x: math.cos(x)
        ## df is the ground truth second derivative function
        df = lambda x: -math.cos(x)
        x = 0.8
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 18: pass')

    def test_hw07_prob01_ut19(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 19 ************')
        f = lambda x: math.log(x, math.e)
        ## df is the ground truth second derivative function
        df = lambda x: -(x**(-2.0))
        x = 1.0
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 19: pass')
        
    def test_hw07_prob01_ut20(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 20 ************')
        f = lambda x: math.log(x, math.e)
        ## df is the ground truth second derivative function
        df = lambda x: -(x**(-2.0))
        x = 1.0
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 20: pass')

    def test_hw07_prob01_ut21(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 21 ************')
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 21: pass')
    ...
    def test_hw07_prob01_ut22(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 22 ************')
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 22: pass')

    def test_hw07_prob01_ut23(self):
        print('\n***** CS3430: S20: HW07: Problem 01: Unit Test 23 ************')
        f = lambda x: 4*(x**5.0) - 3.0*(x**-3.0) + 10.0*(x**2.0) - 5.0*x
        ## rename parser if necessary.
        df = lambda x: 80.0*(x**3.0) - 36.0*(x**-5.0) + 20.0
        x = 1.0
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 01: Unit Test 23: pass')
        
    ### ================ Problem 2: Unit Tests =====================
        
    def test_hw07_prob02_ut01(self):
        print('\n***** CS3430: S20: HW07: Problem 02: Unit Test 01 ************')
        def f(x):
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 02: Unit Test 01: pass')

    def test_hw07_prob02_ut02(self):
        print('\n***** CS3430: S20: HW07: Problem 02: Unit Test 02 ************')
        def f(x):
            n = math.sin(math.sqrt(x**2 + x)/(math.cos(x) - x))**2.0
            d = math.sin((math.sqrt(x) - 1.0)/math.sqrt(x**2.0 + 1))
            return n/d
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 02: Unit Test 02: pass')

    def test_hw07_prob02_ut03(self):
        print('\n***** CS3430: S20: HW07: Problem 02: Unit Test 03 ************')
        def f(x):
            n = math.sin(math.sqrt(x**2 + x)/(math.cos(x) - x))**2.0
            d = math.sin((math.sqrt(x) - 1.0)/math.sqrt(x**2.0 + 1))
            return n/d
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 02: Unit Test 03: pass')

    def test_hw07_prob02_ut04(self):
        print('\n***** CS3430: S20: HW07: Problem 02: Unit Test 04 ************')
        def f(x):
            n = math.sin(math.sqrt(x**2 + x)/(math.cos(x) - x))**2.0
            d = math.sin((math.sqrt(x) - 1.0)/math.sqrt(x**2.0 + 1))
            return n/d
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 02: Unit Test 04: pass')
        
    def test_hw07_prob02_ut05(self):
        print('\n***** CS3430: S20: HW07: Problem 02: Unit Test 05 ************')
        def f(x):
            n = math.sin(math.sqrt(x**2 + x)/(math.cos(x) - x))**2.0
            d = math.sin((math.sqrt(x) - 1.0)/math.sqrt(x**2.0 + 1))
            return n/d
        ...
        x = 0.25
        h = 0.01
        av = rxp.drv3(f, cdd.drv1_ord2, 0.25, 0.01)
        tv = -9.066698771061798
        assert isinstance(av, np.longdouble)
        assert abs(av - tv) <= err
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 02: Unit Test 05: pass')
        
    def test_hw07_prob02_ut06(self):
        print('\n***** CS3430: S20: HW07: Problem 02: Unit Test 06 ************')
        def f(x):
            n = math.sin(math.sqrt(x**2 + x)/(math.cos(x) - x))**2.0
            d = math.sin((math.sqrt(x) - 1.0)/math.sqrt(x**2.0 + 1))
            return n/d
        ...
        x = 0.25
        h = 0.01
        av = rxp.drv3(f, cdd.drv1_ord4, 0.25, 0.01)
        tv = -9.066698774866188
        assert isinstance(av, np.longdouble)
        assert abs(av - tv) <= err
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 02: Unit Test 06: pass')

    def test_hw07_prob02_ut07(self):
        print('\n***** CS3430: S20: HW07: Problem 02: Unit Test 07 ************')
        def f(x):
            n = math.sin(math.sqrt(x**2 + x)/(math.cos(x) - x))**2.0
            d = math.sin((math.sqrt(x) - 1.0)/math.sqrt(x**2.0 + 1))
            return n/d
        ...
        x = 0.25
        h = 0.01
        av = rxp.drv4(f, cdd.drv1_ord2, x, h)
        tv = -9.066698771242361
        assert isinstance(av, np.longdouble)
        assert abs(av - tv) <= err
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 02: Unit Test 07: pass')

    def test_hw07_prob02_ut08(self):
        print('\n***** CS3430: S20: HW07: Problem 02: Unit Test 08 ************')
        def f(x):
            n = math.sin(math.sqrt(x**2 + x)/(math.cos(x) - x))**2.0
            d = math.sin((math.sqrt(x) - 1.0)/math.sqrt(x**2.0 + 1))
            return n/d
        ...
        x = 0.25
        h = 0.01
        av = rxp.drv4(f, cdd.drv1_ord4, x, h)
        tv = -9.06669877124218
        assert isinstance(av, np.longdouble)
        assert abs(av - tv) <= err
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 02: Unit Test 08: pass')

    def test_hw07_prob02_ut09(self):
        print('\n***** CS3430: S20: HW07: Problem 02: Unit Test 09 ************')
        f = lambda x: 4*(x**5.0) - 3.0*(x**-3.0) + 10.0*(x**2) - 5.0*x
        ## rename parser if necessary.
        df = tof.tof(drv.drv(parser.parse_sum('4x^5 - 3x^-3 + 10x^2 - 5x^1')))
        x = 0.5
        ...
        print('av={}'.format(av))
        print('tv={}'.format(tv))
        print('CS 3430: S20: HW07: Problem 02: Unit Test 09: pass')
    ...
    def test_hw07_prob03_ut06(self):
        print('\n***** CS3430: S20: HW07: Problem 03: Unit Test 06 ************')
        def f(x):
            return math.e**(-(x**2.0))
        err = 0.00001
        ...
        print('av = {}'.format(av))
        print('tv = {}'.format(tv))
        print('CS 3430: S20: HW07: Problem 03: Unit Test 06: pass')
        
    def test_hw07_prob03_ut07(self):
        print('\n***** CS3430: S20: HW07: Problem 03: Unit Test 07 ************')
        def f(x):
            return math.e**(-(x**2.0))
        err = 0.00001
        ...
        print('av = {}'.format(av))
        print('tv = {}'.format(tv))
        print('CS 3430: S20: HW07: Problem 03: Unit Test 07: pass')
